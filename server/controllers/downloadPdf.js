  ...
  try {
    ...
    try {
      ...
      for (let i = 0; i < rows.length; i++) {
        ...
        var oRegie = "00:00";
        angajat.oNorma = "00:00";
        for (let j = 0; j < angajat.orePontat.length; j++) {
          if (
            angajat.zile[j].prescurtare === "V" && angajat.orePontat[j].oraR){
              angajat.oNorma = addTimes(angajat.oNorma, "6:00");
            } else if (
              (angajat.zile[j].prescurtare === "L" ||
                angajat.zile[j].prescurtare === "Ma" ||
                angajat.zile[j].prescurtare === "Mi" ||
                angajat.zile[j].prescurtare === "J") && angajat.orePontat[j].oraR
            ) {
              angajat.oNorma = addTimes(angajat.oNorma, "8:30");
            }
          if (
            angajat.zile[j].prescurtare === "V" &&
            comparaOreVineri(angajat.orePontat[j].oraC) == true
